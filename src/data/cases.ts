...
export const casesData: Record<CaseSlug, Record<Lang, CaseStudy>> = {
  'audience-framework': {
    ...
    es: {
      ...
      problem:
        'Los equipos regionales carecían de una metodología estandarizada para entender y segmentar audiencias en diferentes narrativas climáticas. Cada equipo usaba enfoques distintos, haciendo imposible el aprendizaje inter-regional y las decisiones estratégicas inconsistentes.',
      approach: [
      ...
      adoption:
        'Usado por equipos regionales en LATAM, Canadá y Estados Unidos para planificación estratégica y reportes a donantes',
      governance:
        'Colaboración con socios alineados con UE y consorcios filantrópicos en sistemas de monitoreo de desempeño',
      tools: ['Brandwatch', 'BuzzSumo', 'Audiense', 'Google BigQuery', 'Power BI', 'Excel'],
    },
  },
  'benchmark-system': {
    ...
    es: {
      ...
      regions: ['LATAM', 'US/Canadá', 'Europa'],
      problem:
        'La eficiencia de campañas variaba significativamente entre equipos regionales sin forma estandarizada de comparar desempeño o identificar áreas de mejora. Las decisiones estratégicas se tomaban sin datos base comparables.',
      approach: [
      ...
      adoption:
        'Integrado en sesiones de planificación estratégica trimestral en todos los programas regionales',
      governance:
  ...
  'narrative-tracking': {
    ...
    es: {
      ...
      regions: ['Global'],
      problem:
        'Las tendencias del discurso ambiental y los cambios de sentimiento no se monitoreaban sistemáticamente, dificultando evaluar el impacto comunicacional o adaptar la estrategia de mensajes en tiempo real.',
      approach: [
      ...
      adoption:
        'Monitoreado por equipo de comunicaciones, insights consumidos por líderes de programa y socios',
      governance:
        'Pipeline de datos propiedad del equipo de analítica, recomendaciones revisadas por Director de Comunicaciones',
      tools: ['Brandwatch', 'BuzzSumo', 'Event Registry', 'Talkwalker', 'NVivo', 'ATLAS.ti'],
    },
  },
};
